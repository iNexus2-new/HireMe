...
{
    [Authorize]
    public partial class SentModel : PageModel
    {
        private readonly UserManager<User> _userManager;
        private readonly IRepository<Message> messageRepository;

        public SentModel(UserManager<User> userManager, IRepository<Message> messageRepository)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int currentPage)
        {
            ...
            Count = this.messageRepository.Set()
            ...
            if (Count > 0) // prevent 'SqlException: The offset specified in a OFFSET clause may not be negative.'
            {
                ...
                MessageList = this.messageRepository.Set()
                .Where(j => j.SenderId == posterId)
