namespace HireMe.Areas.Identity.Pages.Admin
{
    ...
    public partial class ContestantPostsModel : PageModel
    {
        private readonly UserManager<User> userManager;
        private readonly IContestantsService _contestantService;

        public ContestantPostsModel(UserManager<User> userManager, IContestantsService contestantService)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int currentPage)
        {
            ...
            var entity = _contestantService.GetAllAsNoTracking().Where(x => x.isApproved != 2).OrderByDescending(x => x.Id);
